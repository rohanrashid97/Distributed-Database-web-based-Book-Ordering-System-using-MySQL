...
if (isset($_POST['add_to_cart'])) {
   ...
   $select_book = $conn1->query("SELECT * FROM cart WHERE bid= '$book_id' AND user_id='$user_id' ") or die('query failed');
   ...
   <section class="show-products">
      <div class="box-container">
         ...
         if (isset($_POST['search_btn'])) {
            ...
            $select_products = mysqli_query($conn1, "SELECT * FROM `book_info` WHERE name LIKE '%{$search_box}%' OR title LIKE '%{$search_box}%' OR category LIKE '%{$search_box}%'");
