...
if (isset($_GET['delete_user'])) {
    ...
    mysqli_query($conn1, "DELETE FROM `users_info` WHERE Id = '$delete_id'") or die('query failed');
    mysqli_query($conn2, "DELETE FROM `users_info` WHERE Id = '$delete_id'") or die('query failed');
    mysqli_query($conn3, "DELETE FROM `users_info` WHERE Id = '$delete_id'") or die('query failed');
...
if (isset($_POST['update_user'])) {
    ...
    mysqli_query($conn1, "UPDATE `users_info` SET name = '$update_name', surname='$update_name', email ='$update_email', password = '$update_password', user_type='$update_user_type' WHERE Id = '$update_id'") or die('query failed');
    mysqli_query($conn2, "UPDATE `users_info` SET name = '$update_name', surname='$update_name', email ='$update_email', password = '$update_password', user_type='$update_user_type' WHERE Id = '$update_id'") or die('query failed');
    mysqli_query($conn3, "UPDATE `users_info` SET name = '$update_name', surname='$update_name', email ='$update_email', password = '$update_password', user_type='$update_user_type' WHERE Id = '$update_id'") or die('query failed');
...
<body>
   ...
   <?php
      ...
      $select_user = mysqli_query($conn1, "SELECT Id,name,surname,email,password,user_type FROM users_info WHERE user_type='User'") or die('query failed');
    ...
    <section class="edit_user-form">
        <div class="edit-product-form">
            ...
            if (isset($_GET['update_user'])) {
                ...
                $update_query = mysqli_query($conn1, "SELECT * FROM `users_info` WHERE Id = '$update_id'") or die('query failed');
            ...
            ?>
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <select name="update_branch_type" id="" required class="box">
