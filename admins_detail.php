...
<body>
   ...
   <?php
      ...
      $select_user = mysqli_query($conn1, "SELECT Id,name,surname,email,password,user_type FROM users_info WHERE user_type='Admin'") or die('query failed');
