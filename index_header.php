...
<!-- sersch-bar start-->
<div class="user-box" style="display: flex; padding-left:100px;padding-top:5px;padding-bottom:5px; align-items:center;">
    <a class="Btn" href="search_books.php"><img style="height:30px;" src="./images/sea2.png" alt=""></a>
     </div>
<!-- sersch-bar end -->
  <header>
    <div class="logo" style="display: inline-block; align-items:center;">
        <a href="index.php"><span>Book</span>
            <span class="me">Ordering System</span>
        </a>
    ...
    <div class="nav">
        ...
        <div class="dropdown">
            ...
            <a href="http://localhost:7878/dbos/index.php#New">New Arrived</a>
                <a href="http://localhost:/dbos/index.php#Adventure">Adventure</a>
                <a href="http://localhost:/dbos/index.php#Magical">Magic</a>
                <a href="http://localhost:/dbos/index.php#Knowledge">Knowledge</a>
                <a href="http://localhost:/dbos/index.php#Academic">Academic</a>
            </div>
        </div>
        ...
        echo'<div class="use_links"><a class="link_Btn" style="background-color: #e74c3c;
        padding: 6px;
        border-radius: 10px;
        margin-left: 10px;
        color: white;
        font-weight: 500;" href="login.php">Log In</a><a class="link_Btn " style="background-color: #e74c3c;display:inline-block;   margin-top: 4px !important;
        padding: 6px;
        border-radius: 10px;
        margin-left: 10px;
        color: white;
        font-weight: 500;" href="register.php">Sign Up</a></div>';
