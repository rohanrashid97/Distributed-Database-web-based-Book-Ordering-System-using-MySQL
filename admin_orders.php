...
if (isset($_POST['update_order'])) {
   ...
   mysqli_query($conn1, "UPDATE `confirm_order` SET payment_status = '$update_payment',date='$date' WHERE order_id = '$order_update_id'") or die('query failed');
   mysqli_query($conn2, "UPDATE `confirm_order` SET payment_status = '$update_payment',date='$date' WHERE order_id = '$order_update_id'") or die('query failed');
   mysqli_query($conn3, "UPDATE `confirm_order` SET payment_status = '$update_payment',date='$date' WHERE order_id = '$order_update_id'") or die('query failed');
...
if (isset($_GET['delete'])) {
   ...
   mysqli_query($conn1, "DELETE FROM `confirm_order` WHERE order_id = '$delete_id'") or die('query failed');
   mysqli_query($conn2, "DELETE FROM `confirm_order` WHERE order_id = '$delete_id'") or die('query failed');
   mysqli_query($conn3, "DELETE FROM `confirm_order` WHERE order_id = '$delete_id'") or die('query failed');
...
<body>
   ...
   <section class="placed-orders">
      ...
      <div class="box-container">
         <?php
         $select_orders = mysqli_query($conn1, "SELECT * FROM `confirm_order`") or die('query failed');
