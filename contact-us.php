<?php
    ...
    if(isset($_POST['send_msg'])) {
      ...
      $msg = mysqli_real_escape_string($conn1, $_POST['msg']);
      $email = mysqli_real_escape_string($conn1, $_POST['email']);
      $phone = mysqli_real_escape_string($conn1, $_POST['phone']);

          mysqli_query($conn1, "INSERT INTO msg (`user_id`,`name`,`email`, `number`, `msg`) VALUES('$user_id','$name','$email','$phone','$msg')") or die('Mesage send Query failed');
          mysqli_query($conn2, "INSERT INTO msg (`user_id`,`name`,`email`, `number`, `msg`) VALUES('$user_id','$name','$email','$phone','$msg')") or die('Mesage send Query failed');
          mysqli_query($conn3, "INSERT INTO msg (`user_id`,`name`,`email`, `number`, `msg`) VALUES('$user_id','$name','$email','$phone','$msg')") or die('Mesage send Query failed');
