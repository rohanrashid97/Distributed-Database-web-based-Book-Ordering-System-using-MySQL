        ...
        <div class="sub_main">
            <div class="short_links flex" style="justify-content:center; ">
                ...
                <ul>
                    ...
                    <li>+8801510101010</li>
                    <li>contact@bookorderingsystem.com</li>
                    <li>Address: Mirpur-6</li>
                </ul>

            </div>
        </div>
        <div style=" align-items:center; justify-content:center; margin:20px 0 0 ;" class="cmsg flex">
            <p>Designed By Group "A"  | Copyright &copy; <script>
                    document.write(new Date().getFullYear())
                </script> All Rights are reserved by &nbsp</p>
            <div style="font-size: 30px;" class="logo">
                <a href="index.php"><span style="font-size: 15px;"> Book </span>
                    <span class="me" style="font-size: 15px;">Ordering System</span></a>
            </div> 
        </div>
    </div>
</footer>